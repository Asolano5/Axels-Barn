/*
 Name: Axel Solano
 Course: MIS 3371
 File name: homework4.js
 Date created: 11/13/25
 Date updated: 11/22/25
 Description: Added functions for setting, getting, reading, and deleting
a cookie in regard to the user's first name input.  In addition, save, load, and
clear functions are added to save non-sensitive field inputs to the local storage.
Pop up message handler is added to the onload functions for the page as well as
the logic for the Remember check box that stores the cookie and local storage.
 */
let error_flag = 0;
